...
testspace config url http://$MARK_TOKEN@mark.stridespace.com/munderseth:box_CIs/$BRANCH_NAME
...
# Push
testspace test.xml "+printenv.txt{environment variables}" --repo git